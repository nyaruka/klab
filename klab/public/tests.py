...
class KLabPublicTest(Helpers):
    ...
    def setUp(self):
        ...
        self.user = self.create_user('member', ["Members"])
        ...
        self.member = Member.objects.create(application=self.application, user=self.user, first_name="John",
                                             last_name="Boy",
                                             phone="0786325897",
                                             membership_type="B",
                                             email="john.boy@gmail.com",
    ...
    def test_events_past(self):
        past_event = self.create_event(-1, "$500k Investment Lessons From Seedstars World 2016", "This Thursday meet Louis Antoine Muhire, CEO& Founder of Mergims, who is going to clearly highlight and broadly describe the $500k Investment lessons From Seedstars World 2016.")
    ...
    def test_opportunities_archived(self):
        self.create_opportunity(0, "Apps for African City Life", "Do you have a suggestion on how mobile technology can support City Life and drive innovation for the Networked Society in Africa?", "http://www.ericssonapplicationawards.com/apps-african-city-life")
